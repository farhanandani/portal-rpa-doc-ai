...
import { useClassificationManagement } from "../../../../../react-query/useClassificationManagement";
      ...
      <Modal open={open} onCancel={handleClose} footer={null}>
        <div className="flex flex-col gap-4">
          ...
          <Select
            ...
            options={[
              { label: "Classification DocAI", value: "classification-docai" },
              { label: "Classification DocAI", value: "classification-docai" },
            ]}
          />
